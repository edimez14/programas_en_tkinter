...
def handle_operator(value):
    ...
    if current_number:
        if first_operand is None:
            ...
            first_operand = perform_operation(first_operand, int(current_number), operator)
        current_number = ""
        operator = value
...
def calculate_result():
    ...
    if current_number and operator and first_operand is not None:
        result = perform_operation(first_operand, int(current_number), operator)
        screen.set(result)
...
# button de numeros
buttum_num_punto = ttk.Button(num, text=".", command=lambda: handle_input('.'), style="TButton")
buttum_num_punto.place(x=160, y=261.75, width=78, height=79)
buttum_num_00 = ttk.Button(num, text="00", command=lambda: handle_input('00'), style="TButton")
buttum_num_00.place(x=80, y=261.75, width=78, height=79)
buttum_num_0 = ttk.Button(num, text="0", command=lambda: handle_input('0'), style="TButton")
buttum_num_0.place(x=0, y=261.75, width=78, height=79)
buttum_num_1 = ttk.Button(num, text="1", command=lambda: handle_input('1'), style="TButton")
buttum_num_1.place(x=0, y=174.5, width=78, height=79)
buttum_num_2 = ttk.Button(num, text="2", command=lambda: handle_input('2'), style="TButton")
buttum_num_2.place(x=80, y=174.5, width=78, height=79)
buttum_num_3 = ttk.Button(num, text="3", command=lambda: handle_input('3'), style="TButton")
buttum_num_3.place(x=160, y=174.5, width=78, height=79)
buttum_num_4 = ttk.Button(num, text="4", command=lambda: handle_input('4'), style="TButton")
buttum_num_4.place(x=0, y=87.25, width=78, height=79)
buttum_num_5 = ttk.Button(num, text="5", command=lambda: handle_input('5'), style="TButton")
buttum_num_5.place(x=80, y=87.25, width=78, height=79)
buttum_num_6 = ttk.Button(num, text="6", command=lambda: handle_input('6'), style="TButton")
buttum_num_6.place(x=160, y=87.25, width=78, height=79)
buttum_num_7 = ttk.Button(num, text="7", command=lambda: handle_input('7'), style="TButton")
buttum_num_7.place(x=0, y=0, width=78, height=79)
buttum_num_8 = ttk.Button(num, text="8", command=lambda: handle_input('8'), style="TButton")
buttum_num_8.place(x=80, y=0, width=78, height=79)
buttum_num_9 = ttk.Button(num, text="9", command=lambda: handle_input('9'), style="TButton")
...
op_divi = ttk.Button(op, text="%", command=lambda: handle_operator('/'), style="TButton")
op_divi.place(x=0, y=69.8, width=57, height=67.8)
op_multi = ttk.Button(op, text="*", command=lambda: handle_operator('*'), style="TButton")
op_multi.place(x=0, y=139.6, width=57, height=67.8)
op_res = ttk.Button(op, text="-", command=lambda: handle_operator('-'), style="TButton")
op_res.place(x=0, y=209.4, width=57, height=67.8)
op_sum = ttk.Button(op, text="+", command=lambda: handle_operator('+'), style="TButton")
